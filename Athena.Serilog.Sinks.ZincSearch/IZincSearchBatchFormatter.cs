...
/// </summary>
public interface IZincSearchBatchFormatter
{
    /// <summary>
    /// Format the log events into a payload.
    /// </summary>
    /// <param name="lokiLogEvents">
    /// The events to format wrapped in <see cref="ZincSearchLogEvent"/>.
    /// </param>
    ...
    /// </param>
    void Format(
        IReadOnlyCollection<ZincSearchLogEvent> lokiLogEvents,
