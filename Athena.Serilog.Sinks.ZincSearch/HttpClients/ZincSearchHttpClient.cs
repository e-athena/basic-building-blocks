...
/// </summary>
public class ZincSearchHttpClient : BaseZincSearchHttpClient
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ZincSearchHttpClient"/> class.
    /// </summary>
    /// <param name="httpClient">
    /// <see cref="HttpClient"/> be used for HTTP requests.
    /// </param>
    public ZincSearchHttpClient(HttpClient? httpClient = null)
        : base(httpClient)
    {
    }
