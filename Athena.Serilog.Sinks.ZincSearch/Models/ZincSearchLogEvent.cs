...
/// </summary>
public class ZincSearchLogEvent
{
    /// <summary>
    /// Creates <see cref="ZincSearchLogEvent"/> from <see cref="LogEvent"/>.
    /// </summary>
    /// <param name="logEvent">
    /// A log event.
    /// </param>
    public ZincSearchLogEvent(LogEvent logEvent)
    {
    ...
    internal ZincSearchLogEvent CopyWithProperties(IEnumerable<KeyValuePair<string, LogEventPropertyValue>> properties)
    {
